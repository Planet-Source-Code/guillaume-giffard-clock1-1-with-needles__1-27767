...
Private Sub Form_Load()
    Icon = LoadPicture(App.Path + "\clock02.ico")
    ScaleMode = 2
    FillColor = &HE0E0E0
    FillStyle = 0
    BackColor = &HFFFFFF
...
Private Sub MnAbout_Click()
    If MnEnglish.Checked = True Then
        Call MsgBox("Clock : programmed by Guillaume GIFFARD on Wednesday the 3rd of October 2001" + (Chr(13) & Chr(10)) + "Contact-me at Guiland@mail.com", 64, "About Clock")
    Else
        Call MsgBox("Clock : programmé par Guillaume GIFFARD Mercredi 3 Octobre 2001" + (Chr(13) & Chr(10)) + "Contactez-moi à Guiland@mail.com", 64, "A propos de Clock")
    End If
End Sub
...
Private Sub MnEnglish_Click()
    If MnEnglish.Checked = False Then
        ...
        MnFrench.Checked = False
        Language
    End If
End Sub

Private Sub MnFrench_Click()
    If MnFrench.Checked = False Then
        MnFrench.Checked = True
...
Private Function Language()
    If MnEnglish.Checked = True Then
        ...
        MnFrench.Caption = "French"
        MnAbout.Caption = "&About..."
    Else
        MnDial.Caption = "&Cadran"
        MnCircle.Caption = "Cercle"
        MnSquare.Caption = "Carré"
        MnMovement.Caption = "&Mouvement"
        MnGraduations.Caption = "Crans"
        MnUniform.Caption = "Uniforme"
        MnHours.Caption = "&Horaire"
        MnLanguage.Caption = "&Langue"
        MnEnglish.Caption = "Anglais"
        MnFrench.Caption = "Français"
        MnAbout.Caption = "&A propos..."
    End If
End Function
